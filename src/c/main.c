...
layer_add_child(window_layer, bitmap_layer_get_layer(s_background_layer));
  ...
  s_time_layer = text_layer_create(GRect(0, 120, bounds.size.w, 60));
  ...
  text_date_layer = text_layer_create(GRect( 10, 90, bounds.size.w, 34));
  text_layer_set_text_color(text_date_layer, GColorWhite);
  text_layer_set_background_color(text_date_layer, GColorClear);
  text_layer_set_font(text_date_layer, fonts_get_system_font(FONT_KEY_GOTHIC_18_BOLD));
  text_layer_set_text_alignment(text_date_layer, GTextAlignmentCenter);

  text_daynum_layer = text_layer_create(GRect(-14, 85, bounds.size.w, 34));
  ...
  s_wday_layer = text_layer_create(GRect(-0, 103, bounds.size.w, 34));
  ...
  s_connection_layer = text_layer_create(GRect(-60, 70, bounds.size.w, 34));
  ...
  s_battery_layer = text_layer_create(GRect( 60, 70, bounds.size.w, 34));
